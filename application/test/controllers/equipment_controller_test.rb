...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference("Equipment.count") do
      post equipment_index_url, params: { equipment: { last_maintained: @equipment.last_maintained, last_used: @equipment.last_used, name: @equipment.name } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { last_maintained: @equipment.last_maintained, last_used: @equipment.last_used, name: @equipment.name } }
